...
type TabType = "dashboard" | "trainings" | "partners" | "reports" | "analytics" | "settings";
...
const Dashboard = () => {
  ...
  const navItems = [
    ...
    { id: "partners" as TabType, icon: <Users className="w-5 h-5" />, label: "Partners" },
    { id: "reports" as TabType, icon: <FileText className="w-5 h-5" />, label: "Reports" },
          ...
          <div className="p-6 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">NDMA Platform</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <header className="h-16 border-b border-border bg-card flex items-center justify-between px-4 lg:px-8">
            <div className="flex items-center gap-4 flex-1">
              <h2 className="text-xl font-semibold text-foreground hidden sm:block capitalize">{activeTab}</h2>
              <div className="relative flex-1 max-w-md">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                <Input 
                  placeholder="Search trainings, partners..." 
